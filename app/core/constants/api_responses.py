...
class ApiErrorResponses:
    ...
    INVALID_PARAMS = {
        ...
        "content": {
            "application/json": {"example": {"detail": ErrorMessages.INVALID_PARAMS}}
        },
    }
    ...
    NOT_AUTHENTICATED = {
        ...
        "content": {
            "application/json": {"example": {"detail": ErrorMessages.NOT_AUTHENTICATED}}
        },
    }
    ...
    FORBIDDEN = {
        ...
        "content": {
            "application/json": {"example": {"detail": ErrorMessages.FORBIDDEN}}
        },
    }
    ...
    ACCESS_DENIED = {
        ...
        "content": {
            "application/json": {"example": {"detail": ErrorMessages.ACCESS_DENIED}}
        },
    }
    ...
    USER_NOT_FOUND = {
        ...
        "content": {
            "application/json": {"example": {"detail": ErrorMessages.USER_NOT_FOUND}}
        },
    }
    ...
    INVALID_CREDENTIALS = {
        ...
        "content": {
            "application/json": {
                "example": {"detail": ErrorMessages.INVALID_CREDENTIALS}
            }
        },
    }
    ...
    INVALID_SIGNATURE = {
        ...
        "content": {
            "application/json": {"example": {"detail": ErrorMessages.INVALID_SIGNATURE}}
        },
    }
    ...
    INVALID_PAYMENT_DATA = {
        ...
        "content": {
            "application/json": {
                "example": {"detail": ErrorMessages.INVALID_PAYMENT_DATA}
            }
        },
    }
    ...
    DB_CONNECTION_ERROR = {
        ...
        "content": {
            "application/json": {
                "example": {"detail": ErrorMessages.DB_CONNECTION_ERROR}
            }
        },
    }
...
class ApiSuccessResponses:
    ...
    HEALTH_APP_200 = {
        ...
        "content": {
            "application/json": {
                "example": {"status": "ok", "app": "balance-hub", "debug": False}
            }
        },
    }
